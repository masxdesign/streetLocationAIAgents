...
**No location names in headings:**
H2 headings must not contain specific location names, postcodes, neighbourhood names, or region names. They must be pure thematic angles. For example, use "Flexible Leasing and Community-Driven Retail" — not "Flexible Leasing in West London's W1 Districts".
